...
class Query
{
    ...
    {
        if (property_exists($query, 'root')) {
            $this->root 		= $query->root;
        }
        if (property_exists($query, 'keys')) {
            $this->keys 		= $query->keys;
        }
        if (property_exists($query, 'params')) {
            $this->params 		= $query->params;
        }
        if (property_exists($query, 'defaultParam')) {
            $this->defaultParam	= $query->defaultParam;
        }
        if (property_exists($query, 'operation')) {
            $this->operation 	= $query->operation;
        }
        if (property_exists($query, 'maxResults')) {
